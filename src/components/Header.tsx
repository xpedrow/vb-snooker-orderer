...
const Header: React.FC = () => {
  return (
    <div className="doc-hdr bg-gradient-to-r from-black via-[#1a1a1a] to-black text-white p-[15px_44px_10px_48px] flex justify-between items-start border-b-[2px] border-[#12A15F] relative overflow-hidden flex-shrink-0">
      ...
      <div className="hdr-brand flex items-center gap-5 relative z-10">
        ...
        <div>
          <div className="hdr-title font-brand text-[1.85rem] font-bold leading-none tracking-widest uppercase">
            VB <span className="text-[#12A15F]">Snooker</span>
          </div>
          <div className="hdr-sub font-sans text-[0.62rem] font-bold opacity-90 uppercase tracking-[0.22em] mt-2">
            Mesa de Bilhar · Pebolim · Tênis de Mesa · Desde 1993
          </div>
        </div>
      </div>

      <div className="hdr-info text-right relative z-10 mt-2">
        <div className="space-y-1.5">
          <div className="flex items-center justify-end gap-2 leading-tight">
            <svg className="w-2.5 h-2.5 stroke-gold fill-none" viewBox="0 0 24 24" strokeWidth="3">
            ...
            <span className="text-[0.8rem] font-bold">(15) 99789-6366</span>
          </div>
          <div className="flex items-center justify-end gap-2 leading-tight">
            <svg className="w-2.5 h-2.5 stroke-gold fill-none" viewBox="0 0 24 24" strokeWidth="3">
          ...
          <div className="flex items-center justify-end gap-2 leading-tight">
            ...
            <span className="text-[0.73rem] font-medium text-zinc-300">R. Cônego André Pieroni, 492 — Sorocaba-SP</span>
          </div>
        </div>
